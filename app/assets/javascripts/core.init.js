...
(function ($, window) {
  ...
  if (typeof coreInit == 'undefined') {
    $('body')
      .on('mouseenter', '.navbar.main .username [data-toggle="dropdown"]', function () {
  ...
  // Automagically hide alert messages after 5 seconds.
  setTimeout(function() {
      $(".alert").fadeOut();
      $(".alert").click(function() {$(".alert").fadeOut();});
  }, 5000);
