...
!function ($, moment) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            if (typeof options.sidebar === 'boolean')
            ...
            if (typeof options.startDate === 'undefined' && typeof options.endDate === 'undefined') {
                if ($(this.element).is('input[type=text]')) {
                    ...
                    } else if ((split.length == 1 && val != '') || this.singleDatePicker) {
        ...
        move: function () {
            ...
            if(this.sidebar) {
              this.container.css({
                position: 'fixed',
                top: this.element.offset().top - this.container.outerHeight(),
        ...
        buildCalendar: function (month, year, hour, minute, side) {
            ...
            while (startDay > daysInLastMonth)
                startDay -= 7;
